...
if __name__ == '__main__':
    ...
    parser.add_argument('--datacfg', type=str, default='cfg/010101.data') # data config
    parser.add_argument('--modelcfg', type=str, default='cfg/yolo-pose.cfg') # network config
    parser.add_argument('--weightfile', type=str, default='backup/010101/model.weights') # imagenet initialized weights
