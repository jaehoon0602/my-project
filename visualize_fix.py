...
if __name__ == '__main__':
    ...
    parser.add_argument('--datacfg', type=str, default='data/tissue/tissue.data') # data config
    parser.add_argument('--modelcfg', type=str, default='cfg/yolo-pose.cfg') # network config
    parser.add_argument('--weightfile', type=str, default='data/tissue/model/model.weights') # imagenet initialized weights
