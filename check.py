...
if __name__ == '__main__':
    ...
    parser.add_argument('--datacfg', type=str, default='data/060201.bookshelf1/bookshelf1.data')  # data config
    ...
    if (os.path.isdir("experimental_results/" + name + "_check") == 0): os.mkdir(
        "experimental_results/" + name + "_check")
    ...
    for count in range(0, nts):
        ...
        R_gt, t_gt = pnp(
            ...
            corners2D, np.array(intrinsic_calibration, dtype='float32'))
        ...
        rep_acc.append(rep)
        cv2.line(img, (int(corners2Dp[0][0]), int(corners2Dp[0][1])), (int(corners2Dp[1][0]), int(corners2Dp[1][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[0][0]), int(corners2Dp[0][1])), (int(corners2Dp[2][0]), int(corners2Dp[2][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[1][0]), int(corners2Dp[1][1])), (int(corners2Dp[3][0]), int(corners2Dp[3][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[2][0]), int(corners2Dp[2][1])), (int(corners2Dp[3][0]), int(corners2Dp[3][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[0][0]), int(corners2Dp[0][1])), (int(corners2Dp[4][0]), int(corners2Dp[4][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[1][0]), int(corners2Dp[1][1])), (int(corners2Dp[5][0]), int(corners2Dp[5][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[2][0]), int(corners2Dp[2][1])), (int(corners2Dp[6][0]), int(corners2Dp[6][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[3][0]), int(corners2Dp[3][1])), (int(corners2Dp[7][0]), int(corners2Dp[7][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[4][0]), int(corners2Dp[4][1])), (int(corners2Dp[5][0]), int(corners2Dp[5][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[4][0]), int(corners2Dp[4][1])), (int(corners2Dp[6][0]), int(corners2Dp[6][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[5][0]), int(corners2Dp[5][1])), (int(corners2Dp[7][0]), int(corners2Dp[7][1])),
                 [255, 0, 255], 2)
        cv2.line(img, (int(corners2Dp[6][0]), int(corners2Dp[6][1])), (int(corners2Dp[7][0]), int(corners2Dp[7][1])),
                 [255, 0, 255], 2)
    ...
    file.write("{:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f}".format(rep_test05, rep_test10, rep_test15,
                                                                                    iou_test25, iou_test50, iou_test75))
    file.close()
    ...
    file.write("{:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f}".format(rep_test05, rep_test10, rep_test15,
                                                                                    iou_test25, iou_test50, iou_test75))
    file.close()
    print("{}: {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f} {:>10.2f}".format(name, rep_test05, rep_test10,
                                                                                   rep_test15, iou_test25, iou_test50,
                                                                                   iou_test75))
